...
Run `boop update` from the shell for a safe preview. Run `/upgrade-boop` inside the repo from `claude` when you want the agent to perform the merge, resolve conflicts, or run referenced migration skills.
